<template>
   <vk-modal :show.sync="show" class="terms-and-conditions">
      ...
      <h2>Hyperlinking to our Content</h2>
        ...
        the visibility associated with the hyperlink outweighs the absence of Credit by Monet; and (d) where the
        ...
        you must notify us by sending an e-mail to <a href="mailto:support@creditbymonet.com" title="send an email to support@creditbymonet.com">support@creditbymonet.com</a>.
        ...
        <p>No use of Credit by Monet’s logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>
      <h2>Iframes</h2>
