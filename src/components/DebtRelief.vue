<!-- Component that renders section of the page for debt relief.  The one that
  contains the map. -->
<template>
      ...
      <vk-grid gutter="large" class="uk-child-width-expand@m">
        ...
        <div class="uk-width-2-5@m debt-copy">
          <div>
            ...
            <p>Credit by Monet offers access to the tools and assistance you need
              so that you can repair your credit and rebuild for a
              fresh start.
